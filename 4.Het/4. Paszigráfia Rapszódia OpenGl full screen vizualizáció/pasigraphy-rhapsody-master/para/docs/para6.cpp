...
void drawPaRaCube ( int idx )
{
        ...
        glColor3f ( 1.000f, 0.627f, 0.478f ); //háttérszín a kockákon
        ...
        glBegin ( GL_LINES );
        glColor3f (1.000f, 0.843f, 0.000f); //elülső élek
        ...
        glBegin ( GL_LINES );
        glColor3f (1.000f, 0.843f, 0.000f); // jobb oldali élek
        ...
        glBegin ( GL_LINES );
        glColor3f (1.000f, 0.843f, 0.000f); // kockák tetején az élek
        ...
        glBegin ( GL_LINES );
        glColor3f (1.000f, 0.843f, 0.000f); //kocka bal oldalán az élek
        ...
        glBegin ( GL_LINES );
        glColor3f (1.000f, 0.843f, 0.000f); //kocka hátoldalán az élek
        ...
        glBegin ( GL_LINES );
        glColor3f (1.000f, 0.843f, 0.000f); //kocka alján az élek
...
void draw ( void )
{
        glClearColor ( 0.098f, 0.098f, 0.439f, 1.0f ); //háttérszíne
